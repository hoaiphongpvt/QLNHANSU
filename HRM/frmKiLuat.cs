...
namespace HRM
{
    public partial class frmKiLuat : DevExpress.XtraEditors.XtraForm
    {
        public frmKiLuat()
        {
            InitializeComponent();
        ...
        void loadData()
        {
            gcDanhSach.DataSource = ktkl.getListFull(2);
        ...
        private void frmKiLuat_Load(object sender, EventArgs e)
        {
